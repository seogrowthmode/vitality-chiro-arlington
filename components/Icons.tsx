...
export function LogoIcon({ className = "w-8 h-8" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none">
      <circle cx="16" cy="16" r="14" stroke="#58BFBA" strokeWidth="2.5" />
      <path d="M16 6C16 6 10 14 10 18c0 4 2.7 7 6 7s6-3 6-7c0-4-6-12-6-12z" fill="#58BFBA" opacity=".25" />
      <path d="M16 10v12M12 16h8" stroke="#58BFBA" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}

export function SpineIcon({ className = "w-8 h-8" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
      <path d="M16 4v24M16 4c-2 3-3 7-3 10s1 7 3 10M16 4c2 3 3 7 3 10s-1 7-3 10" />
      <path d="M10 14h12" />
    </svg>
  );
}
