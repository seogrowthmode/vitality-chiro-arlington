          ...
          <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-20">
            <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-14 items-center">
              ...
              <div className="rounded-[18px] overflow-hidden shadow-[var(--shadow-card)] relative min-h-[400px]">
                <Image src="/images/services/advanced-spinal-correction-clinic-treatment-2.webp" alt="Advanced spinal correction treatment at Vitality Family Chiropractic — corrective chiropractic care in Arlington, TX" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 42vw" />
              </div>
            </div>
          </div>
        </section>
