...
export default function NeckPainPage() {
  return (
    <>
          ...
          <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-20">
            <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-14 items-center">
              ...
              <div className="rounded-[18px] overflow-hidden shadow-[var(--shadow-card)] relative min-h-[380px]">
                <Image src="/images/services/chiropractic-adjustments-clinic-treatment-1.webp" alt="Chiropractic treatment for neck pain — cervical spine adjustment at Vitality Family Chiropractic in Arlington, TX" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 42vw" />
              </div>
            </div>
          </div>
        </section>
      ...
      <ConversionCTA headline="Stop living with neck pain." subtext='Book your <span class="text-accent">$67</span> exam and find out what&apos;s causing it.' />
    </>
  );
}
